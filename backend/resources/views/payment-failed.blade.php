...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-slate-100">
        ...
        <div class="space-y-3">
            ...
            <a href="https://wa.me/628xxxxxxxxxx" target="_blank" class="block w-full bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium text-sm py-3 px-4 rounded-xl transition duration-200">
